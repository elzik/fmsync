...
(get-content "c:\program files\fmsync\worker\appSettings.json") | foreach-object {$_ -replace '"WatchedDirectoryPaths": \[\]', '"WatchedDirectoryPaths": ["C:\\Users\\justin.elzik\\Obsidian"]'} | set-content "c:\program files\fmsync\worker\appSettings.json"
